    ...
    <div class="container my-4 g-0">
        ...
        <div class="justify-content-center m-2">
            ...
            <div class="page-image-container rounded">
                <img src="{{ asset('assets_cvsm/images/temporary/about-history-timeline.png') }}" alt="History Image" class="img-fluid page-content-image">
            </div>
...
CVSM continues to uphold its core values of excellence and dedication towards its mission to produce veterinarians that are globally competent and service-oriented to contribute to animal health and food security through countryside development.
                    ...
                    <!-- Why CLSU CVSM -->
                    <div class="page-content-text my-4">
                        <div class="container-fluid mt-5">
                            <h4 class="section-subtitle font-blue space-down2">Why CLSU-CVSM?</h4>
                        </div>

                        <ul class="mx-3 ">
                            <li>The DVM Curriculum meets the minimum requirements of the Commission on Higher Education (CHED).</li>
                            <li>Recognized by CHED as one of the Centers of Excellence in Veterinary Education.</li>
                            <li>Level IV accredited by the Accrediting Agency of Chartered Colleges and Universities of the Philippines (AACCUP).</li>
                            <li>International membership at University Consortium-SEARCA, Asian Association of Veterinary Schools (AAVS), Southeast Asian One Health University Network (SEAOHUN).</li>
                            <li>Conforms to ISO 9001:2015.</li>
                            <li>Has a strong curriculum founded on general education (GE) courses, general science, animal science and veterinary courses.</li>
                            <li>Has sufficient facilities, infrastructure, research projects, and access to specialized research centers and laboratories in the University as a venue for the conduct of research and fieldwork of students and faculty.</li>
                            <li>Has qualified academic staff with advanced educational degrees.</li>
                            <li>Has highly engaged academic staff in externally and internally funded research.</li>
                            <li>Has academic staff with membership in national and international professional and scientific organizations.</li>
                            <li>Has academic staff with Scopus-indexed, and other reputable journal publications.</li>
                            <li>Has strong partnerships with industry partners.</li>
                            <li>Has forged linkages with national and international institutions.</li>
                            <li>Has excellent performance of graduates in Veterinary Licensure Exam with top notchers and higher passing rate than the national passing rate.</li>
                            <li>Has outstanding achievements of the graduates in government, academe, and private industries locally and abroad.</li>
                        </ul> 
