...
<body>
    <div class="navbar-wrapper">
        ...
        <nav class="navbar navbar-expand-xl navbar-dark position-relative sticky-top">
            <div class="container">
                <div></div>
            <!-- Hamburger Bar -->
    ...
    <script>
        ...
        //VISIBILITY OF LOGO IN RESPONSIVE
        // Function to check the screen width and toggle logo visibility
        function checkScreenWidth() {
            ...
            var isOffcanvasOpen = offcanvas.classList.contains('show');

            // Check screen width and toggle logo visibility
            if (window.innerWidth < 570 && isOffcanvasOpen) {
                hideLogo();
            } else {
                showLogo();
            }
    ...
    <script>
        //called in document.ready hehehhe
