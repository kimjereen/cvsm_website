...
<section class="page-wrapper">
    ...
    <div class="container-fluid back-link-container">
        <div class="d-flex flex-row text-white align-items-center">
            <a href="{{ route('histology') }}#tab-mammals" class="back-link px-2"><i class="bi bi-house-fill btn-icon"></i> Mammals</a> /
            <a href="{{ route('othermammals') }}" class="back-link2 px-2"> Other Mammals</a>
        </div>  
    </div>
    ...
    <div class="container my-4 g-0">
        ...
        <h3 class="section-subtitle font-blue">OTHER MAMMAL IMAGES</h3>
        </div>
            ...
            <div class="col mt-3 gallery-item">
                <div class="card rounded-shadow img-zoom-container" data-bs-toggle="modal" data-bs-target="#imageModal">
                    ...
                    <div class="card-body1">
                        <h5 class="card-title">Cow Body</h5>
                    </div>
