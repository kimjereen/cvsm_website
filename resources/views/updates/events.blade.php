            ...
            <div class="row page-content-card rounded">
                <div class="col-lg g-0">
                    <div class="event-date-container d-flex align-items-center">
                        <div class="w-100 text-center py-4">
                            <h3 class="news-year">FEBRUARY</h3>
                            <h1 class="news-date">27</h1>
                            <h3 class="news-month">2024</h3>
                        </div>
                    </div>
                </div>  
                <div class="col-lg p-4 d-flex flex-column justify-content-between ">
                    ...
                    <div class="news-content-footer px-1">
                        <a href="{{ route('readevent') }}" class="btn btn-primary cont-reading">Continue Reading <i class="bi bi-arrow-right btn-icon"></i></a>
                    </div>
                </div>
            </div>
