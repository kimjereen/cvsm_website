...
<!-- PAGE CONTENT STARTS HERE -->
    ...
    <div class="container my-4">
        ...
        <div class="container my-4">
                ...
                <!-- for other purposes nalang hehehheheheheh :>>
                <div class="row row-cols-1 row-cols-md-2 p-1">

                    <div class="col g-0 p-2">
                        <div class="row page-content-card rounded-shadow">
                            <div class="col-lg g-0">
                                <div class="news-image-container g-0">
                                    <img src="{{ asset('assets_cvsm/images/temporary/bones.jpg') }}" class="img-fluid" alt="Headline Image">
                                </div>
                            </div> 
                            <div class="col-lg p-4 d-flex flex-column justify-content-between ">
                                <div class="news-content-body ">
                                    <h3 class="news-headline">This is a news. there is a news herea8fg</h3>
                                    <div class="d-flex flex-row">
                                        <p class="card-text"><small class="text-muted"><i class="bi bi-person-fill"></i> Admin</small></p>
                                        <p class="card-text mx-3"><small class="text-muted"><i class="bi bi-pencil-fill"></i> 3 mins ago</small></p>
                                    </div>
                                </div>
                                <div class="news-content-footer px-1">
                    ...
                    <div class="col g-0 p-2">
                        <div class="row page-content-card rounded-shadow">
                            ...
                            <div class="col-lg p-4 d-flex flex-column justify-content-between ">
                                <div class="news-content-body">
                                    <h3 class="news-headline">This is a news. there is a news here ddd</h3>
                                    <div class="d-flex flex-row">
                                        <p class="card-text "><small class="text-muted"><i class="bi bi-person-fill"></i> Admin</small></p>
                                        <p class="card-text mx-3"><small class="text-muted"><i class="bi bi-pencil-fill"></i> 3 mins ago</small></p>
                                    </div>
    ...
    <div class="container my-4">
        ...
        <!--  other usage nalang din ito
        <div class="container my-4 bg-secondary g-0">
