<div class="accordion accordion-flush" id="accordionChild1">
    ...
    <div class="accordion-item">
        ...
        VMED 7100 - Advanced Veterinary Immunology (3 units)
        </button>
        </h2>
    ...
    <div class="accordion-item">
        ...
        VMED 7200 - Advanced Veterinary Research Methods ( 2 units)
        </button>
        </h2>
    ...
    <div class="accordion-item">
        ...
        VMED 7300 - Advanced Veterinary Epidemiology (3 units)
        </button>
        </h2>
    ...
    <div class="accordion-item">
        <h2 class="accordion-header" id="child-heading4">
        <button class="accordion-button collapsed child-accord" type="button" data-bs-toggle="collapse" data-bs-target="#child-collapse4" aria-expanded="false" aria-controls="child-collapse4">
        VMED 7400 - One Health (3 units)
        </button>
        </h2>
