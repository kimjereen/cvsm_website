...
<!-- PAGE CONTENT STARTS HERE -->
    ...
    <div class="container my-4">
        ...
        <div class="container-fluid mt-5 g-0">
            <h3 class="section-subtitle font-blue space-down1">ABOUT</h3>
        </div>
    ...
    <div class="container my-4 g-0"  id="mvst-program-of-study">
        <!-- Section Title -->
        <div class="container-fluid mt-5">
    ...
    <div class="container my-4 g-0" id="mvst-courses-and-description">
        <!-- Section Title -->
        <div class="container-fluid mt-5">
            ...
            <div class="page-content-card rounded">
                    <div class="container page-content-body">
                        ...
                        <div class="accordion accordion-flush my-3" id="accordionFlushMVSt">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="mvst-headingFour">
                                <button class="accordion-button collapsed parent-accord" type="button" data-bs-toggle="collapse" data-bs-target="#mvst-collapseFour" aria-expanded="false" aria-controls="mvst-collapseFour">
                                    COGNATE
                                </button>
                                </h2>
                                <div id="mvst-collapseFour" class="accordion-collapse collapse" aria-labelledby="mvst-headingFour" data-bs-parent="#accordionFlushMVSt">
                                    <div class="accordion-body">
